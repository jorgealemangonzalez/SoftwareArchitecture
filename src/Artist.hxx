...
public:
    ...
    const std::string descriptionCatalog(){ //if a catalog it's empty it throws the error correct
    	return description() + catalogTracks();//+ catalogTracks() + catalogAlbum(); // The description of the catalog is the result of the convination of the artist description and catalogTracks
    }
